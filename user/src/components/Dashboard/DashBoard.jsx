...
const Dashboard = () => {
  ...
  const handleOptionClick = (option) => {
    ...
    switch (option) {
      case "Total CHEF":
        setSelectedFilterComponent(<Analytics />);
        break;
      case "Total Revenue":
        setSelectedFilterComponent(<Analytics />);
        break;
      ...
      {isOverlayOpen && (
        <div className="filterOverlay" ref={overlayRef}>
          <div className="filter-options">
            <button onClick={() => handleOptionClick("Total CHEF")}>
              Total CHEF
            </button>
            <button onClick={() => handleOptionClick("Total Revenue")}>
              Total Revenue
            </button>
            <button onClick={() => handleOptionClick("Total Orders")}>
              Total Orders
            </button>
            <button onClick={() => handleOptionClick("Total Clients")}>
              Total Clients
            </button>
